...
public class SudokuSolver {
    ...
    public static void main(String args[]) {
        new SudokuSolver(new int[][] {
            ...
            {1, 3, 0, 0, 0, 0, 2, 5, 0},
            {0, 0, 0, 0, 0, 0, 0, 7, 4},
            {0, 0, 5, 2, 0, 6, 3, 0, 0}   //calling constructor and passing Sudoku
        }).solve(); //calls the solve method 
    }

    private int sudoku[][];
    private int n = 9;

    public SudokuSolver(int sudoku[][]) {   //Sudoku is stored through constructor
        this.sudoku = sudoku;
    }

    public void solve() { //sudoku 2-D array store the input 
    ...
    public boolean isSuitableToPutXThere(int i, int j, int x) {
        //validation of cells, you can verify using boolean matrix also
        //this is another method to verify cell  
